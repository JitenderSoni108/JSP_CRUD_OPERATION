...
public boolean registerEmp(RegisterBean rb) {
	...
	try {
		...
		if(x!=0) {
            ...
            System.out.println("login into db"+x1);
            if(x1!=0) {
			flag=true;
			return flag;
            }
...
//getAll records
		...
		System.out.println("all records set into arraylist"+al);
		return al;
        }
